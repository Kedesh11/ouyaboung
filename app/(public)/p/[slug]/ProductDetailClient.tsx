...
export default function ProductDetailClient({ product: initialProduct, slug }: ProductDetailClientProps) {
  ...
  const [product] = useState<FoodItem>(initialProduct);
            ...
            <div className="relative aspect-square rounded-3xl overflow-hidden shadow-2xl border bg-muted">
              ...
              <div className="absolute top-6 left-6 flex flex-wrap gap-2">
                ...
                {product.quantity_available < 5 && (
                  <Badge
                    variant="destructive"
                    className="shadow-lg text-lg px-4 py-1.5 rounded-full animate-pulse"
                  >
            ...
            <div className="flex-1 space-y-8">
              ...
              <div className="bg-muted/30 rounded-2xl p-6 border space-y-4">
                ...
                <div className="pt-4 flex items-center gap-2 text-green-600 font-bold justify-center bg-green-50/50 py-2 rounded-xl border border-green-100">
                  ...
                  Vous économisez{" "}
                  {(product.original_price - product.discounted_price).toLocaleString()} XAF !
                </div>
              </div>
                ...
                <div className="bg-card border rounded-2xl p-4 flex items-center gap-4 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">
                      {product.pickup_start} - {product.pickup_end}
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        En réservant ce produit, vous luttez activement contre le gaspillage
                        alimentaire au Gabon tout en faisant des économies.
                      </p>
                    </div>
                  </div>
                </CardContent>
